...
export class Snake extends Animal {
  ...
  private readonly nbr0TempG: number = 20;

  // For generate gène Meal
  private readonly nbrRandomMealG: number = 15;
  private readonly nbr0MealG: number = 55;

  // For generate gène Plante
  private readonly nbrRandomPlantsG: number = 15;
  private readonly nbr0PlantsG: number = 65;

  // For generate gène Water
  private readonly nbrRandomWater: number = 10;
  private readonly nbr0Water: number = 70;

  // For generate gène Resistance
  private readonly nbrRandomRestistance: number = 15;
  private readonly nbr0Restistance: number = 30;

  // For generate gène Agressiveness
  private readonly nbrRandomAgressiveness: number = 15;
  private readonly nbr0Agressiveness: number = 20;
  ...
  private generateAnimal() {
    ...
    this.typeOfAnmal = AnimalTypeEnum.SNAKE;
  }
