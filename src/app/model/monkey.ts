...
export class Monkey extends Animal {
  ...
  private readonly nbr0TempG: number = 40;

  // For generate gène Meal
  private readonly nbrRandomMealG: number = 20;
  private readonly nbr0MealG: number = 40;

  // For generate gène Plante
  private readonly nbrRandomPlantsG: number = 20;
  private readonly nbr0PlantsG: number = 40;

  // For generate gène Water
  private readonly nbrRandomWater: number = 20;
  private readonly nbr0Water: number = 40;

  // For generate gène Resistance
  private readonly nbrRandomRestistance: number = 20;
  private readonly nbr0Restistance: number = 40;

  // For generate gène Agressiveness
  private readonly nbrRandomAgressiveness: number = 5;
  private readonly nbr0Agressiveness: number = 75;
  ...
  private generateAnimal() {
    ...
    this.typeOfAnmal = AnimalTypeEnum.MONKEY;
  }
