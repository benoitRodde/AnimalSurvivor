...
export class Rat extends Animal {
  ...
  private readonly nbr0TempG: number = 30;

  // For generate gène Meal
  private readonly nbrRandomMealG: number = 25;
  private readonly nbr0MealG: number = 50;

  // For generate gène Plante
  private readonly nbrRandomPlantsG: number = 25;
  private readonly nbr0PlantsG: number = 50;

  // For generate gène Water
  private readonly nbrRandomWater: number = 15;
  private readonly nbr0Water: number = 65;
  ...
  private readonly nbrRandomAgressiveness: number = 20;
  private readonly nbr0Agressiveness: number = 60;
  ...
  private generateAnimal() {
    ...
    this.typeOfAnmal = AnimalTypeEnum.RAT;
  }
